<div class="flex flex-wrap text-neutral-500">
    ...
    <a class="profile-link" href="https://github.com/dmalusev" target="_blank"
       ...
       aria-label="Github" rel="me noopener noreferrer">
                        <span class="relative inline-block align-text-bottom px-1 icon">
                            <svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512"><path fill="currentColor"
    ...
    <a class="profile-link px-1 transition-transform hover:scale-125 hover:text-primary-400"
       style="will-change:transform;" href="https://www.linkedin.com/in/malusevd998" target="_blank"
       data-type="linkedin"
    ...
    <a class="profile-link px-1 transition-transform hover:scale-125 hover:text-primary-400 will-change"
