        ...
        DEFAULT: {
          css: {
            ...
            '--tw-prose-th-borders': theme(
                'colors.neutral.500 / 1'),
            '--tw-prose-td-borders': theme(
                'colors.neutral.300 / 1'),
            ...
            a: {
              ...
              textDecorationColor: theme(
                  'colors.primary.300 / 1'),
              fontWeight: '500',
              '&:hover': {
                color: theme('colors.neutral.DEFAULT / 1'),
                textDecoration: 'none',
                backgroundColor: theme(
                    'colors.primary.600 / 1'),
